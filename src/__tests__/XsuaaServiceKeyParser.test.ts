...
describe('XsuaaServiceKeyParser', () => {
  ...
  describe('parse', () => {
    ...
    it('should preserve abap.url if present', () => {
      ...
      expect(result.abap?.url).toBe('https://abap.test.com');
    });
    ...
    it('should preserve optional fields', () => {
      ...
      expect(result.sap_url).toBe('https://sap.test.com');
      expect(result.client).toBe('001');
      expect(result.sap_client).toBe('001');
